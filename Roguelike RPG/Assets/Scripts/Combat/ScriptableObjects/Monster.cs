...
public class Monster : ScriptableObject
{
    ...
    public struct MaterialToEvolveQuantityPair{
        public Material materialToEvolve;
        public int quanity;
    }
    //Create a list with the structure of material and quantity
    [SerializeField]
    private List<MaterialToEvolveQuantityPair> MaterialAndQuantityToEvolveList = new List<MaterialToEvolveQuantityPair>();
    ...
    public List<Material> GetMaterialsToEvolve(){
    ...
    public int GetQuantityOfAMaterialNeededToEvolve(string materialName){
        foreach(var pair in MaterialAndQuantityToEvolveList){
            if(pair.materialToEvolve.MaterialName == materialName){
                return pair.quanity;
            }
        }
